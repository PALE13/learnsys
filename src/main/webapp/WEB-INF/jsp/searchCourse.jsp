            ...
            <div class="panel panel-default wk-panel wk-table-tools-panel">
                <div class="panel-heading">
				 ...
				 <div style="position: absolute;top: -11px;left: 240px;">
					...
					<div>
						<button id="deleteBtn" type="button" class="btn btn-default wk-tool-btn" style="position: absolute;top: 10px;right: -360px;">删除</button>
		                <button id="updateBtn" type="button" class="btn btn-default wk-tool-btn" style="position: absolute;top: 10px;right: -280px;">编辑</button>
					</div>
				 </div>
				 <!-- 搜索 end -->
            </div>
