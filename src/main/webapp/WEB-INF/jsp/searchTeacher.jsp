                ...
                <div class="panel-heading">
				 ...
				 <div style="position: absolute;top: -11px;left: 240px;">
					<form class="navbar-form navbar-right" role="search" 
							action="<%=basePath%>searchTeacherByTerm.html" method="post">
						<div class="form-group">
							<input type="text" class="form-control" name="searchContent" placeholder="教师编号">
						</div> 
						<div class="form-group">
					...
					<div>
						<button id="deleteBtn" type="button" class="btn btn-default wk-tool-btn" style="position: absolute;top: 10px;right: -380px;">删除</button>
		                <button id="updateBtn" type="button" class="btn btn-default wk-tool-btn" style="position: absolute;top: 10px;right: -300px;">编辑</button>
					</div>
				 </div>
				 <!-- 搜索 end -->
            </div>
		...
		<div class="col-lg-12">
			<div class="panel panel-default  wk-panel">
				<table class="table table-striped table-hover">
					...
					<tbody>
						<c:forEach items="${teachers}" var="var">
						<tr>
