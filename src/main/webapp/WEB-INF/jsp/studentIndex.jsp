    ...
    <div class="row">
        <div class="col-lg-12">
            <ul class="nav nav-tabs wk-nav-menu" id="wk-nav-menu">
                ...
                <li role="presentation"><a href="javascript:void();" id="wk-menu-panel-item-searchTaskInfo" class="wk-main-menu-item">查看考试</a></li>
                <li role="presentation"><a href="javascript:void();" id="wk-menu-panel-item-searchStudentTaskInfo" class="wk-main-menu-item">查询已完成考试</a></li>
                    ...
                    <div class="panel-group wk-accordion-panel-group" id="accordion">
                        ...
                        <div class="panel panel-info wk-accordion-header">
                            ...
                            <div id="AMenu" class="panel-collapse collapse">    
                                <div class="list-group wk-accordion-list-group">
                                    <button type="button" class="list-group-item" id="wk-menu-panel-item-searchTaskInfo"> >&nbsp;&nbsp;进入考试</button>
                                    <button type="button" class="list-group-item" id="wk-menu-panel-item-searchStudentTaskInfo"> >&nbsp;&nbsp;查询已完成考试</button>
                                </div>
                            </div>
                        </div>
