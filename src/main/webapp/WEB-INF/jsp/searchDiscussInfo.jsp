            ...
            <div class="panel panel-default wk-panel wk-table-tools-panel">
                <div class="panel-heading">
				 ...
				 <div style="position: absolute;top: -11px;left: 240px;">
					...
					<div>
						<button id="scanBtn" type="button" class="btn btn-default wk-tool-btn" style="position: absolute;top: 8px;right: -220px;">查看回复</button>
	                	<button id="replyBtn" type="button" class="btn btn-default wk-tool-btn" style="position: absolute;top: 8px;right: -300px;">回复</button>
					</div>
				 </div>
				 <!-- 搜索 end --> 
            </div>
