                ...
                <!-- 搜索 start -->
				 <div style="position: absolute;top: -11px;left: 240px;">
					<form class="navbar-form navbar-right" role="search" 
							action="<%=basePath%>searchCourseVideoInfoByTerm.html" method="post">
						<!-- 
					...
					<div>
						<button id="videoBtn" type="button" class="btn btn-default wk-tool-btn" style="position: absolute;top: 10px;right: -300px;">在线观看</button>
					</div>
				 </div>
				 <!-- 搜索 end --> 
            </div>
