	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default wk-panel ">
				...
				<form action="<%=basePath%>editCourse/${course.id}.html" method="POST">
						...
						<div class="row">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input required="required" name="num" type="text"
											class="form-control wk-normal-input" value="${course.num}"
											placeholder="请输入课程编号" />
									</div>
								</div>
								<div class="form-group">
									<label for="filePath" class="control-label wk-filed-label">所属学院:
										...
										<c:forEach items="${colleges}" var="var">
											<c:choose>
								          		<c:when test="${var.id == course.collegeId}">
							...
							<div class="form-inline">
								<div class="form-group">
									...
									<div class="input-group">
										<input required="required" name="intro" type="tel"
											class="form-control wk-long-2col-input"  value="${course.intro}"
											placeholder="请输入课程介绍" />
									</div>
								</div>
